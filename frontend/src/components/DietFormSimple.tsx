...
interface DietFormSimpleProps {
  onSubmit: (data: DietRequest) => void;
  loading: boolean;
}

const DietFormSimple: React.FC<DietFormSimpleProps> = ({ onSubmit, loading }) => {
  ...
  return (
    <div className="card">
      <h2 style={{ fontSize: '24px', marginBottom: '24px', color: '#1f2937', fontWeight: '600' }}>
